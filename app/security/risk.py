...
TOOL_RISK: dict[str, RiskLevel] = {
    ...
    "forensic.copilot_status": RiskLevel.READ,
    "forensic.copilot_ask": RiskLevel.READ,
    "forensic.autonomous_investigate": RiskLevel.MODIFICATION,
    "forensic.list_investigation_runs": RiskLevel.READ,
    "forensic.show_investigation_run": RiskLevel.READ,
